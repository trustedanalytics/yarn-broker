...
import org.trustedanalytics.servicebroker.yarn.plans.binding.YarnBindingClientFactory;

import com.google.common.collect.ImmutableMap;

public class YarnPlanMultitenantTest {
  @Test
  public void bind_doNothing_returnMultitenantCredentialsMap() throws Exception {
    //arrange
    YarnPlanMultitenant plan = new YarnPlanMultitenant(
        YarnBindingClientFactory.create(new Credentials(ImmutableMap.of("test", "test"))));
    ...
    assertThat(actualOutputCredentials, hasEntry("queue", "%{queue}"));
  }
}
